...
$url        = 'https://github.com/mitiya/chocoGUI/releases/download/0.4/chocoGUIv2.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'testmit*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
